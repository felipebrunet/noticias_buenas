...
PROMPT = "Dime una noticia relevante en la web, de la última semana, puede ser de cualquier tema, tú eliges, tiene que ser reciente de la última semana. Tu texto debe tener en la primera línea un título de máximo 4 palabras, a partir de la segunda línea, el contenido, indicando la URL de la o las fuentes. En la última línea debes indicar los tags de la noticia, pueden ser 1 o 2 tags, como prefieras"
